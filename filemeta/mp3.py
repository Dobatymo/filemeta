...
from typing import IO, Callable, Dict, Tuple, Union, Optional, Iterable, Type
...
def read_bytes_to_namedtuple(fr: IO[bytes], fmt: str, namedtuplecls: Type[namedtuple], conv: Optional[Dict[int, Callable]]=None) -> namedtuple:
...
def read_bits_to_namedtuple(fr: IO[bytes], fmt: str, namedtuplecls: Type[namedtuple], conv: Optional[Dict[int, Callable]]=None) -> namedtuple:
...
Mp3Header = namedtuple("Mp3Header", ["sync", "id", "layer", "protection", "bitrate", "frequency", "padding", "private", "mode", "mode_extension", "copyright", "home_original", "emphasis"])

Mp3SideInformation = namedtuple("Mp3SideInformation", ["main_data_begin", "private_bits", "scfsi", "par2_3_length", "big_values", "global_gain", "scalefac_compress", "windows_switching_flag", "block_type", "mixed_blockflag", "table_select", "subblock_gain", "region0_count", "region1_count", "preflag", "scalfac_scale", "count1table_select"])

Id3v2Header = namedtuple("Id3v2Header", ["major_version", "revision_number", "a", "b", "c", "d", "e", "f", "g", "h", "size"])
...
BITRATE_MAP = {
	1: {ID.MPEG_1: {Layer.LAYER_I: 32, Layer.LAYER_II: 32, Layer.LAYER_III: 32}, ID.MPEG_2: {Layer.LAYER_I: 32, Layer.LAYER_II: 32, Layer.LAYER_III: 8}},
	2: {ID.MPEG_1: {Layer.LAYER_I: 64, Layer.LAYER_II: 48, Layer.LAYER_III: 40}, ID.MPEG_2: {Layer.LAYER_I: 64, Layer.LAYER_II: 48, Layer.LAYER_III: 16}},
	3: {ID.MPEG_1: {Layer.LAYER_I: 96, Layer.LAYER_II: 56, Layer.LAYER_III: 48}, ID.MPEG_2: {Layer.LAYER_I: 96, Layer.LAYER_II: 56, Layer.LAYER_III: 24}},
	4: {ID.MPEG_1: {Layer.LAYER_I: 128, Layer.LAYER_II: 64, Layer.LAYER_III: 56}, ID.MPEG_2: {Layer.LAYER_I: 128, Layer.LAYER_II: 64, Layer.LAYER_III: 32}},
	5: {ID.MPEG_1: {Layer.LAYER_I: 160, Layer.LAYER_II: 80, Layer.LAYER_III: 64}, ID.MPEG_2: {Layer.LAYER_I: 160, Layer.LAYER_II: 80, Layer.LAYER_III: 64}},
	6: {ID.MPEG_1: {Layer.LAYER_I: 192, Layer.LAYER_II: 96, Layer.LAYER_III: 80}, ID.MPEG_2: {Layer.LAYER_I: 192, Layer.LAYER_II: 96, Layer.LAYER_III: 80}},
	7: {ID.MPEG_1: {Layer.LAYER_I: 224, Layer.LAYER_II: 112, Layer.LAYER_III: 96}, ID.MPEG_2: {Layer.LAYER_I: 224, Layer.LAYER_II: 112, Layer.LAYER_III: 56}},
	8: {ID.MPEG_1: {Layer.LAYER_I: 256, Layer.LAYER_II: 128, Layer.LAYER_III: 112}, ID.MPEG_2: {Layer.LAYER_I: 256, Layer.LAYER_II: 128, Layer.LAYER_III: 64}},
	9: {ID.MPEG_1: {Layer.LAYER_I: 288, Layer.LAYER_II: 160, Layer.LAYER_III: 128}, ID.MPEG_2: {Layer.LAYER_I: 288, Layer.LAYER_II: 160, Layer.LAYER_III: 128}},
	10: {ID.MPEG_1: {Layer.LAYER_I: 320, Layer.LAYER_II: 192, Layer.LAYER_III: 160}, ID.MPEG_2: {Layer.LAYER_I: 320, Layer.LAYER_II: 192, Layer.LAYER_III: 160}},
	11: {ID.MPEG_1: {Layer.LAYER_I: 352, Layer.LAYER_II: 224, Layer.LAYER_III: 192}, ID.MPEG_2: {Layer.LAYER_I: 352, Layer.LAYER_II: 224, Layer.LAYER_III: 112}},
	12: {ID.MPEG_1: {Layer.LAYER_I: 384, Layer.LAYER_II: 256, Layer.LAYER_III: 224}, ID.MPEG_2: {Layer.LAYER_I: 384, Layer.LAYER_II: 256, Layer.LAYER_III: 128}},
	13: {ID.MPEG_1: {Layer.LAYER_I: 416, Layer.LAYER_II: 320, Layer.LAYER_III: 256}, ID.MPEG_2: {Layer.LAYER_I: 416, Layer.LAYER_II: 320, Layer.LAYER_III: 256}},
	14: {ID.MPEG_1: {Layer.LAYER_I: 448, Layer.LAYER_II: 384, Layer.LAYER_III: 320}, ID.MPEG_2: {Layer.LAYER_I: 448, Layer.LAYER_II: 384, Layer.LAYER_III: 320}},
}
...
def read_sideinfo(fr: IO[bytes], header: Mp3Header) -> Mp3SideInformation:
	...
	if single_channel:
		...
		for i in range(2):
			...
			par2_3_length, big_values, global_gain, scalefac_compress, windows_switching_flag = bitstruct.unpack_from(SIDE_INFORMATION_SINGLE_FMT_2, data, delta)
			delta += 34

			if windows_switching_flag == 1:
				block_type, mixed_blockflag, table_select, subblock_gain = bitstruct.unpack_from(SIDE_INFORMATION_SINGLE_FMT_3_SWITCH, data, delta)
				region0_count = None
				region1_count = None
			else:
				block_type = 10
				mixed_blockflag = None
				table_select, region0_count, region1_count = bitstruct.unpack_from(SIDE_INFORMATION_SINGLE_FMT_3_NOSWITCH, data, delta)
				subblock_gain = None
			delta += 22

			preflag, scalfac_scale, count1table_select = bitstruct.unpack_from(SIDE_INFORMATION_SINGLE_FMT_4, data, delta)
			delta += 3
		...
		for i in range(2):
			...
			par2_3_length, big_values, global_gain, scalefac_compress, windows_switching_flag = bitstruct.unpack_from(SIDE_INFORMATION_NONSINGLE_FMT_2, data, delta)
			delta += 68

			if windows_switching_flag == 1:
				block_type, mixed_blockflag, table_select, subblock_gain = bitstruct.unpack_from(SIDE_INFORMATION_NONSINGLE_FMT_3_SWITCH, data, delta)
				delta += 26
			else:
				block_type, mixed_blockflag = None, None
				table_select, region0_count, region1_count = bitstruct.unpack_from(SIDE_INFORMATION_NONSINGLE_FMT_3_NOSWITCH, data, delta)
				delta += 30
				subblock_gain = None

			preflag, scalfac_scale, count1table_select = bitstruct.unpack_from(SIDE_INFORMATION_NONSINGLE_FMT_4, data, delta)
			delta += 6


	side_information_tuple = (main_data_begin, private_bits, scfsi, par2_3_length, big_values, global_gain, scalefac_compress, windows_switching_flag, block_type, mixed_blockflag, table_select, subblock_gain, region0_count, region1_count, preflag, scalfac_scale, count1table_select)
...
def read_lyrics3v1(fr: IO[bytes]) -> Tuple[int, Dict[str, str]]:
	...
	pos = fr.tell()
	tag = read_or_raise(fr, length(tag_begin))
	...
	with open(path, "rb") as fr:
		...
		while True:
			try:
				...
				for func in [read_apev2, read_lyricsv2, read_lyricsv1, read_id3v1]:
					try:
						yield func(fr)
						continue
